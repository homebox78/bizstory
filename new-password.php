...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="/metronic8/demo1/../demo1/authentication/layouts/corporate/sign-in.html" action="#">
    <!--begin::Heading-->
